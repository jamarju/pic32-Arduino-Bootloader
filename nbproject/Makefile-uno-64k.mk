...
ifeq "$(wildcard nbproject/Makefile-local-uno-64k.mk)" "nbproject/Makefile-local-uno-64k.mk"
include nbproject/Makefile-local-uno-64k.mk
endif
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-uno-64k.mk dist/${CND_CONF}/${IMAGE_TYPE}/pic32-Arduino-Bootloader.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=32MX320F064H
...
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/pic32bootloader.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -mips16 -D_BOARD_DIGILENT_UNO_ -Os -MMD -MF "${OBJECTDIR}/pic32bootloader.o.d" -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c  
