...
ifeq "$(wildcard nbproject/Makefile-local-microchip-pic32-USB-starter-kit.mk)" "nbproject/Makefile-local-microchip-pic32-USB-starter-kit.mk"
include nbproject/Makefile-local-microchip-pic32-USB-starter-kit.mk
endif
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-microchip-pic32-USB-starter-kit.mk dist/${CND_CONF}/${IMAGE_TYPE}/pic32-Arduino-Bootloader.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/pic32bootloader.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -mips16 -D_BOARD_CEREBOT_32MX4_ -Os -MMD -MF "${OBJECTDIR}/pic32bootloader.o.d" -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c  
	
else
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/pic32bootloader.o.d 
	@${FIXDEPS} "${OBJECTDIR}/pic32bootloader.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -mips16 -D_BOARD_CEREBOT_32MX4_ -Os -MMD -MF "${OBJECTDIR}/pic32bootloader.o.d" -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c  
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} -r dist/microchip-pic32-USB-starter-kit
