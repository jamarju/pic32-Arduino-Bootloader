...
ifeq "$(wildcard nbproject/Makefile-local-uno-128k.mk)" "nbproject/Makefile-local-uno-128k.mk"
include nbproject/Makefile-local-uno-128k.mk
endif
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-uno-128k.mk dist/${CND_CONF}/${IMAGE_TYPE}/pic32-Arduino-Bootloader.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/pic32bootloader.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -mips16 -D_BOARD_DIGILENT_UNO_ -Os -MMD -MF "${OBJECTDIR}/pic32bootloader.o.d" -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c  
	
else
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/pic32bootloader.o.d 
	@${FIXDEPS} "${OBJECTDIR}/pic32bootloader.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -mips16 -D_BOARD_DIGILENT_UNO_ -Os -MMD -MF "${OBJECTDIR}/pic32bootloader.o.d" -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c  
